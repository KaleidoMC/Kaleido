...
public class ChiselPalette {
	...
	public static void init() {
		...
		new ChiselPalette("VSlab", ChiselModule.CHISELED_VSLAB, state -> state.is(ChiselModule.CHISELED_VSLAB));
		...
		new ChiselPalette("SideThinPost", ChiselModule.CHISELED_THIN_POST, state -> state.is(ChiselModule.CHISELED_THIN_POST));
	}
